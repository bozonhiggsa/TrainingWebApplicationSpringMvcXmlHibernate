...
<head>
    ...
    <link href=<c:url value="/static/animate.css"/> rel="stylesheet">
    <link href=<c:url value="/static/main.css"/> rel="stylesheet">
    <link href=<c:url value="/static/carousel.css"/> rel="stylesheet">
</head>
<body>
        <header id="header" class="header">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                        <img src="/static/logo.png" alt="Logo" class="logo animated bounce">
                    </div>
                    <div class="col-lg-5">
                        <nav>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img src="/static/community.jpg" alt="Community" class="community">
                    </div>
                </div>
            </div>
        </header>
                    ...
                    <div class="col-lg-10 offset-lg-1">
                        <div class="swiper-container main-slider" id="myCarousel">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide slider-bg-position" style="background:url(/static/fox1.jpg)" data-hash="slide1">
                                </div>
                                <div class="swiper-slide slider-bg-position" style="background:url(/static/fox2.jpg)" data-hash="slide2">
                                </div>
                                <div class="swiper-slide slider-bg-position" style="background:url(/static/fox3.jpg)" data-hash="slide3">
                                </div>
                            </div>
                            <!-- Add Pagination -->
        ...
        <script src="<c:url value="/static/carousel.js" />"></script>
</body>
</html>